...
import RajniiRobot.modules.sql.global_bans_sql as gban_sql
import RajniiRobot.modules.sql.users_sql as user_sql
from RajniiRobot import DEV_USERS, OWNER_ID, dispatcher
