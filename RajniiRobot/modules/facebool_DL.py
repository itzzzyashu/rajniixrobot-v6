...
from RajniiRobot.utils.pluginhelpers import is_admin
from RajniiRobot import telethn, BOT_USERNAME, SUPPORT_CHAT
...
async def _(event):
    ...
    if await is_admin(event, event.message.sender_id):
        ...
        await telethn.send_file(
            ...
            kk,
            caption=
            f"Facebook Video downloaded Successfully by @{BOT_USERNAME}.\nSay hi to devs @{SUPPORT_CHAT}.",
        )
        os.system(f"rm {kk}")
    else:
