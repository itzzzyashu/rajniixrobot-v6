...
import RajniiRobot.modules.sql.blacklist_sql as sql
from RajniiRobot import dispatcher, LOGGER
from RajniiRobot.modules.disable import DisableAbleCommandHandler
from RajniiRobot.modules.helper_funcs.chat_status import user_admin, user_not_admin
from RajniiRobot.modules.helper_funcs.extraction import extract_text
from RajniiRobot.modules.helper_funcs.misc import split_message
from RajniiRobot.modules.log_channel import loggable
from RajniiRobot.modules.warns import warn
    ...
    if len(words) > 1:
        ...
        if len(to_blacklist) == 1:
            ...
            send_message(
                ...
                format(len(to_blacklist), html.escape(chat_name)),
                parse_mode=ParseMode.HTML,
            )
